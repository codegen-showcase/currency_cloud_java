...
public class HttpRequestBuilder {
    ...
    private Object unpackInner(Object value) {
        if (value instanceof Optional) {
            Optional<Object> optObj = (Optional<Object>) value;
            return unpackInner(optObj.orElse(null));
        } else if (value instanceof Patch) {
            Patch<Object> patch = (Patch<Object>) value;
            return unpackInner(patch.orElse(null));
        } else {
            return value;
        }
    }
