...
/**
 * BalancesTopUpMarginBody
 */
@JsonDeserialize(builder = BalancesTopUpMarginBody.Builder.class)
public final class BalancesTopUpMarginBody {
    /**
     * Amount to top up.
     */
    ...
    private BalancesTopUpMarginBody(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BalancesTopUpMarginBody && equalTo((BalancesTopUpMarginBody) other);
    }

    private boolean equalTo(BalancesTopUpMarginBody other) {
        return
    ...
    public String toString() {
        return "BalancesTopUpMarginBody{" +
               "amount=" + amount + ", " +
               "currency=" + currency + ", " +
    ...
    public static final class Builder {
        ...
        public Builder from(BalancesTopUpMarginBody other) {
        ...
        public BalancesTopUpMarginBody build() {
            if (amount == null) {
            ...
            return new BalancesTopUpMarginBody(this);
        }
    }
