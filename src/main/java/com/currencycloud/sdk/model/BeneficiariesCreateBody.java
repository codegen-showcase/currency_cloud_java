...
/**
 * BeneficiariesCreateBody
 */
@JsonDeserialize(builder = BeneficiariesCreateBody.Builder.class)
public final class BeneficiariesCreateBody {
    /**
     * Bank account number.
     */
     ...
     * Bank account type.
     */
    private final Optional<BeneficiariesCreateBodyBankAccountTypeEnum> bankAccountType;
    ...
    /**
     * City name, should not consists of only numbers.
     */
     ...
     * Legal entity
     */
    private final Optional<BeneficiariesCreateBodyBeneficiaryEntityTypeEnum> beneficiaryEntityType;
     ...
     */
    private final Optional<BeneficiariesCreateBodyBeneficiaryIdentificationTypeEnum>
    ...
    /**
     * Currency in which money is held in the beneficiary's bank account. Three-letter IDO currency code.
     */
     ...
     */
    private final Optional<List<BeneficiariesCreateBodyPaymentTypesItemEnum>> paymentTypes;

    /**
     * Local payment routing system. If supplied, routing_code_value_1 should also be supplied.
     */
    private final Optional<BeneficiariesCreateBodyRoutingCodeType1Enum> routingCodeType1;

    /**
     * Local payment routing system. If supplied, routing_code_value_2 should also be supplied.
     */
    private final Optional<BeneficiariesCreateBodyRoutingCodeType2Enum> routingCodeType2;
    ...
    private BeneficiariesCreateBody(Builder builder) {
    ...
    @JsonInclude(JsonInclude.Include.NON_ABSENT)
    public Optional<BeneficiariesCreateBodyBankAccountTypeEnum> getBankAccountType() {
    ...
    @JsonInclude(JsonInclude.Include.NON_ABSENT)
    public Optional<BeneficiariesCreateBodyBeneficiaryEntityTypeEnum> getBeneficiaryEntityType() {
    ...
    @JsonInclude(JsonInclude.Include.NON_ABSENT)
    public Optional<BeneficiariesCreateBodyBeneficiaryIdentificationTypeEnum>
    ...
    @JsonInclude(JsonInclude.Include.NON_ABSENT)
    public Optional<List<BeneficiariesCreateBodyPaymentTypesItemEnum>> getPaymentTypes() {
        return paymentTypes;
    }
    /**
    ...
    @JsonInclude(JsonInclude.Include.NON_ABSENT)
    public Optional<BeneficiariesCreateBodyRoutingCodeType1Enum> getRoutingCodeType1() {
    ...
    @JsonInclude(JsonInclude.Include.NON_ABSENT)
    public Optional<BeneficiariesCreateBodyRoutingCodeType2Enum> getRoutingCodeType2() {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BeneficiariesCreateBody && equalTo((BeneficiariesCreateBody) other);
    }

    private boolean equalTo(BeneficiariesCreateBody other) {
        return
    ...
    public String toString() {
        return "BeneficiariesCreateBody{" +
    ...
    public static final class Builder {
         ...
         * Bank account type.
         */
        private Optional<BeneficiariesCreateBodyBankAccountTypeEnum> bankAccountType = Optional.empty();
         ...
         * Legal entity
         */
        private Optional<BeneficiariesCreateBodyBeneficiaryEntityTypeEnum> beneficiaryEntityType =
            Optional.empty();
         ...
         * A legal document that verifies the identity of the beneficiary. Required documentation will vary depending on the country in which the beneficiar's bank account is held and on whether "beneficiary_entity_type" is "individual" or "company".
         */
        private Optional<BeneficiariesCreateBodyBeneficiaryIdentificationTypeEnum>
         ...
         * Currencycloud supports two types of payments: "priority", made using the Swift network; and "regular", made using the local bank network.
         */
        private Optional<List<BeneficiariesCreateBodyPaymentTypesItemEnum>> paymentTypes = Optional.empty();

        /**
         * Local payment routing system. If supplied, routing_code_value_1 should also be supplied.
         */
        private Optional<BeneficiariesCreateBodyRoutingCodeType1Enum> routingCodeType1 = Optional.empty();

        /**
         * Local payment routing system. If supplied, routing_code_value_2 should also be supplied.
         */
        private Optional<BeneficiariesCreateBodyRoutingCodeType2Enum> routingCodeType2 = Optional.empty();
        ...
        public Builder from(BeneficiariesCreateBody other) {
        ...
        public Builder bankAccountHolderName(String bankAccountHolderName) {
            if (bankAccountHolderName == null) {
                throw new IllegalArgumentException("bankAccountHolderName cannot be null");
            }
        ...
        public Builder bankAccountType(Optional<BeneficiariesCreateBodyBankAccountTypeEnum>
                                       bankAccountType) {
         ...
         * Bank account type.
         */
        public Builder bankAccountType(BeneficiariesCreateBodyBankAccountTypeEnum bankAccountType) {
        ...
        public Builder beneficiaryEntityType(Optional<BeneficiariesCreateBodyBeneficiaryEntityTypeEnum>
         ...
         * Legal entity
         */
        public Builder beneficiaryEntityType(BeneficiariesCreateBodyBeneficiaryEntityTypeEnum
                                             beneficiaryEntityType) {
        ...
        public Builder beneficiaryIdentificationType(
            Optional<BeneficiariesCreateBodyBeneficiaryIdentificationTypeEnum> beneficiaryIdentificationType) {
         ...
         */
        public Builder beneficiaryIdentificationType(
            BeneficiariesCreateBodyBeneficiaryIdentificationTypeEnum beneficiaryIdentificationType) {
        ...
        public Builder paymentTypes(Optional<List<BeneficiariesCreateBodyPaymentTypesItemEnum>>
                                    paymentTypes) {
         ...
         * Currencycloud supports two types of payments: "priority", made using the Swift network; and "regular", made using the local bank network.
         */
        public Builder paymentTypes(List<BeneficiariesCreateBodyPaymentTypesItemEnum> paymentTypes) {
        ...
        public Builder routingCodeType1(Optional<BeneficiariesCreateBodyRoutingCodeType1Enum>
                                        routingCodeType1) {
         ...
         * Local payment routing system. If supplied, routing_code_value_1 should also be supplied.
         */
        public Builder routingCodeType1(BeneficiariesCreateBodyRoutingCodeType1Enum routingCodeType1) {
        ...
        public Builder routingCodeType2(Optional<BeneficiariesCreateBodyRoutingCodeType2Enum>
                                        routingCodeType2) {
         ...
         * Local payment routing system. If supplied, routing_code_value_2 should also be supplied.
         */
        public Builder routingCodeType2(BeneficiariesCreateBodyRoutingCodeType2Enum routingCodeType2) {
        ...
        public BeneficiariesCreateBody build() {
            if (bankAccountHolderName == null) {
                throw new IllegalStateException("bankAccountHolderName is required");
            }
            ...
            return new BeneficiariesCreateBody(this);
        }
    }
