 ...
 * ContactsCreateBody
 */
@JsonDeserialize(builder = ContactsCreateBody.Builder.class)
public final class ContactsCreateBody {
    /**
     * Account UUID
     */
    ...
    private ContactsCreateBody(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ContactsCreateBody && equalTo((ContactsCreateBody) other);
    }

    private boolean equalTo(ContactsCreateBody other) {
        return
    ...
    public static final class Builder {
        ...
        public Builder from(ContactsCreateBody other) {
        ...
        public ContactsCreateBody build() {
            if (accountId == null) {
            ...
            return new ContactsCreateBody(this);
        }
    }
