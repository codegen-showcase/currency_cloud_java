 ...
 * ContactsFindBody
 */
@JsonDeserialize(builder = ContactsFindBody.Builder.class)
public final class ContactsFindBody {
    /**
     * Sub-Account UUID
     */
    ...
    private ContactsFindBody(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ContactsFindBody && equalTo((ContactsFindBody) other);
    }

    private boolean equalTo(ContactsFindBody other) {
        return
    ...
    public static final class Builder {
        ...
        public Builder from(ContactsFindBody other) {
        ...
        public ContactsFindBody build() {
            return new ContactsFindBody(this);
        }
    }
