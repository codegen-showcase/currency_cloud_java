...
/**
 * PaymentsValidateBody
 */
@JsonDeserialize(builder = PaymentsValidateBody.Builder.class)
public final class PaymentsValidateBody {
    /**
     * Amount
     */
     ...
     */
    private final Optional<PaymentsValidateBodyChargeTypeEnum> chargeType;
    ...
    /**
     * Currency in which payment is made. Three-digit currency code.
     */
    ...
    /**
     * If "payer_entity_type" is "company", this is the company registration date. If "payer_entity_type" is "individual", this is the individual's date of birth. ISO 8601 format YYYY-MM-DD.
     */
     ...
     * Legal entity
     */
    private final Optional<PaymentsValidateBodyPayerEntityTypeEnum> payerEntityType;
     ...
     */
    private final Optional<PaymentsValidateBodyPayerIdentificationTypeEnum> payerIdentificationType;
     ...
     */
    private final Optional<PaymentsValidateBodyPaymentTypeEnum> paymentType;

    /**
     * Payment Purpose Code (Mandatory for all INR payments).
     */
    ...
    private PaymentsValidateBody(Builder builder) {
    ...
    public Optional<PaymentsValidateBodyChargeTypeEnum> getChargeType() {
        return chargeType;
    }
    /**
    ...
    @JsonInclude(JsonInclude.Include.NON_ABSENT)
    public Optional<PaymentsValidateBodyPayerEntityTypeEnum> getPayerEntityType() {
    ...
    @JsonInclude(JsonInclude.Include.NON_ABSENT)
    public Optional<PaymentsValidateBodyPayerIdentificationTypeEnum> getPayerIdentificationType() {
    ...
    @JsonInclude(JsonInclude.Include.NON_ABSENT)
    public Optional<PaymentsValidateBodyPaymentTypeEnum> getPaymentType() {
        return paymentType;
    }
    /**
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PaymentsValidateBody && equalTo((PaymentsValidateBody) other);
    }

    private boolean equalTo(PaymentsValidateBody other) {
        return
    ...
    public static final class Builder {
         ...
         * Payment Charges Setting value (only applicable to Swift payments). If empty - then account's default value is used. Do not specify for regular (local) payments.
         */
        private Optional<PaymentsValidateBodyChargeTypeEnum> chargeType = Optional.empty();
         ...
         * Legal entity
         */
        private Optional<PaymentsValidateBodyPayerEntityTypeEnum> payerEntityType = Optional.empty();
         ...
         * A legal document that verifies the identity of the payer. Required documentation will vary depending on the nationality or registered address of the payer.
         */
        private Optional<PaymentsValidateBodyPayerIdentificationTypeEnum> payerIdentificationType =
            Optional.empty();
         ...
         * Currencycloud supports two types of payments: "priority", made using the Swift network; and "regular", made using the local bank network.
         */
        private Optional<PaymentsValidateBodyPaymentTypeEnum> paymentType = Optional.empty();
        ...
        public Builder from(PaymentsValidateBody other) {
        ...
        public Builder chargeType(Optional<PaymentsValidateBodyChargeTypeEnum> chargeType) {
         ...
         * Payment Charges Setting value (only applicable to Swift payments). If empty - then account's default value is used. Do not specify for regular (local) payments.
         */
        public Builder chargeType(PaymentsValidateBodyChargeTypeEnum chargeType) {
        ...
        public Builder payerEntityType(Optional<PaymentsValidateBodyPayerEntityTypeEnum> payerEntityType) {
         ...
         * Legal entity
         */
        public Builder payerEntityType(PaymentsValidateBodyPayerEntityTypeEnum payerEntityType) {
        ...
        public Builder payerIdentificationType(Optional<PaymentsValidateBodyPayerIdentificationTypeEnum>
         ...
         * A legal document that verifies the identity of the payer. Required documentation will vary depending on the nationality or registered address of the payer.
         */
        public Builder payerIdentificationType(PaymentsValidateBodyPayerIdentificationTypeEnum
                                               payerIdentificationType) {
        ...
        public Builder paymentType(Optional<PaymentsValidateBodyPaymentTypeEnum> paymentType) {
         ...
         * Currencycloud supports two types of payments: "priority", made using the Swift network; and "regular", made using the local bank network.
         */
        public Builder paymentType(PaymentsValidateBodyPaymentTypeEnum paymentType) {
        ...
        public PaymentsValidateBody build() {
            if (amount == null) {
            ...
            return new PaymentsValidateBody(this);
        }
    }
