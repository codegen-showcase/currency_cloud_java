...
/**
 * ReportsGenerateConversionReportBody
 */
@JsonDeserialize(builder = ReportsGenerateConversionReportBody.Builder.class)
public final class ReportsGenerateConversionReportBody {
    /**
    ...
    private ReportsGenerateConversionReportBody(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ReportsGenerateConversionReportBody &&
               equalTo((ReportsGenerateConversionReportBody) other);
    }

    private boolean equalTo(ReportsGenerateConversionReportBody other) {
        return
    ...
    public String toString() {
        return "ReportsGenerateConversionReportBody{" +
    ...
    public static final class Builder {
        ...
        public Builder from(ReportsGenerateConversionReportBody other) {
        ...
        public ReportsGenerateConversionReportBody build() {
            return new ReportsGenerateConversionReportBody(this);
        }
    }
