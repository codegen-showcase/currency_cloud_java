...
/**
 * TermsAndConditionsAcceptBody
 */
@JsonDeserialize(builder = TermsAndConditionsAcceptBody.Builder.class)
public final class TermsAndConditionsAcceptBody {
    /**
    ...
    private TermsAndConditionsAcceptBody(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TermsAndConditionsAcceptBody &&
               equalTo((TermsAndConditionsAcceptBody) other);
    }

    private boolean equalTo(TermsAndConditionsAcceptBody other) {
        return
    ...
    public String toString() {
        return "TermsAndConditionsAcceptBody{" +
               "email=" + email + ", " +
               "firstName=" + firstName + ", " +
               "lastName=" + lastName + ", " +
    ...
    public static final class Builder {
        ...
        public Builder from(TermsAndConditionsAcceptBody other) {
        ...
        public TermsAndConditionsAcceptBody build() {
            if (email == null) {
            ...
            return new TermsAndConditionsAcceptBody(this);
        }
    }
