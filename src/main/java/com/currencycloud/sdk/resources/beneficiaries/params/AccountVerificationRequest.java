 ...
 */
@JsonDeserialize(builder = AccountVerificationRequest.Builder.class)
public final class AccountVerificationRequest {
    ...
    private AccountVerificationRequest(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AccountVerificationRequest && equalTo((AccountVerificationRequest) other);
    }

    private boolean equalTo(AccountVerificationRequest other) {
        return
    ...
    public static final class Builder {
        ...
        public Builder from(AccountVerificationRequest other) {
        ...
        public AccountVerificationRequest build() {
            if (accountNumber == null) {
            ...
            return new AccountVerificationRequest(this);
        }
    }
