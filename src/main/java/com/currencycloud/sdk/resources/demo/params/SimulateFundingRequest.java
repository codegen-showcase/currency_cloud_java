...
package com.currencycloud.sdk.resources.demo.params;
...
/**
 * SimulateFundingRequest
 */
@JsonDeserialize(builder = SimulateFundingRequest.Builder.class)
public final class SimulateFundingRequest {
    /**
    ...
    private SimulateFundingRequest(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SimulateFundingRequest && equalTo((SimulateFundingRequest) other);
    }

    private boolean equalTo(SimulateFundingRequest other) {
        return
    ...
    public static final class Builder {
        ...
        public Builder from(SimulateFundingRequest other) {
        ...
        public SimulateFundingRequest build() {
            if (amount == null) {
            ...
            return new SimulateFundingRequest(this);
        }
    }
