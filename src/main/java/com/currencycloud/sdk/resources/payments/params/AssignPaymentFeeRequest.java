...
/**
 * AssignPaymentFeeRequest
 */
@JsonDeserialize(builder = AssignPaymentFeeRequest.Builder.class)
public final class AssignPaymentFeeRequest {
    /**
    ...
    private AssignPaymentFeeRequest(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AssignPaymentFeeRequest && equalTo((AssignPaymentFeeRequest) other);
    }

    private boolean equalTo(AssignPaymentFeeRequest other) {
        return
    ...
    public String toString() {
        return "AssignPaymentFeeRequest{" +
               "accountId=" + accountId + ", " +
    ...
    public static final class Builder {
        ...
        public Builder from(AssignPaymentFeeRequest other) {
        ...
        public AssignPaymentFeeRequest build() {
            if (accountId == null) {
            ...
            return new AssignPaymentFeeRequest(this);
        }
    }
