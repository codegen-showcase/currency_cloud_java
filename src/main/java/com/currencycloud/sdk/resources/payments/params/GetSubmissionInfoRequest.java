...
/**
 * GetSubmissionInfoRequest
 */
@JsonDeserialize(builder = GetSubmissionInfoRequest.Builder.class)
public final class GetSubmissionInfoRequest {
    /**
     * Payment UUID
     */
    ...
    private GetSubmissionInfoRequest(Builder builder) {
        this.id = builder.id;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetSubmissionInfoRequest && equalTo((GetSubmissionInfoRequest) other);
    }

    private boolean equalTo(GetSubmissionInfoRequest other) {
        return
            id.equals(other.id) &&
    ...
    public String toString() {
        return "GetSubmissionInfoRequest{" +
               "id=" + id + ", " +
    ...
    public static final class Builder {
        ...
        public Builder from(GetSubmissionInfoRequest other) {
            id(other.getId());
        ...
        public GetSubmissionInfoRequest build() {
            if (id == null) {
                throw new IllegalStateException("id is required");
            }

            return new GetSubmissionInfoRequest(this);
        }
    }
