 ...
 * ValidateRequest
 */
@JsonDeserialize(builder = ValidateRequest.Builder.class)
public final class ValidateRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ValidateRequest && equalTo((ValidateRequest) other);
    }

    private boolean equalTo(ValidateRequest other) {
        return
    ...
    public static final class Builder {
        ...
        public Builder from(ValidateRequest other) {
