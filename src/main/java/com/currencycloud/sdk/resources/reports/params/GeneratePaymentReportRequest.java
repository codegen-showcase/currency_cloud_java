 ...
 */
@JsonDeserialize(builder = GeneratePaymentReportRequest.Builder.class)
public final class GeneratePaymentReportRequest {
    /**
    ...
    private GeneratePaymentReportRequest(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GeneratePaymentReportRequest &&
               equalTo((GeneratePaymentReportRequest) other);
    }

    private boolean equalTo(GeneratePaymentReportRequest other) {
        return
    ...
    public String toString() {
        return "GeneratePaymentReportRequest{" +
    ...
    public static final class Builder {
        ...
        public Builder from(GeneratePaymentReportRequest other) {
        ...
        public GeneratePaymentReportRequest build() {
            return new GeneratePaymentReportRequest(this);
        }
    }
