 ...
 */
@JsonDeserialize(builder = GetSenderDetailsRequest.Builder.class)
public final class GetSenderDetailsRequest {
    /**
    ...
    private GetSenderDetailsRequest(Builder builder) {
        this.id = builder.id;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetSenderDetailsRequest && equalTo((GetSenderDetailsRequest) other);
    }

    private boolean equalTo(GetSenderDetailsRequest other) {
        return
            id.equals(other.id) &&
    ...
    public String toString() {
        return "GetSenderDetailsRequest{" +
               "id=" + id + ", " +
    ...
    public static final class Builder {
        ...
        public Builder from(GetSenderDetailsRequest other) {
            id(other.getId());
        ...
        public GetSenderDetailsRequest build() {
            if (id == null) {
                throw new IllegalStateException("id is required");
            }

            return new GetSenderDetailsRequest(this);
        }
    }
